...
if (isset($_SERVER['HTTP_HOST'])) {
	...
	$server_url="https://SamSweets.ru";
}
define('BASE_URL', $server_url);

define('BASE_URL_RESERV',"https://SamSweets.ru");
...
require_once ROOT_DIR . '/app/modules/shop/init.php';
require_once ROOT_DIR . '/app/modules/bbparser/init.php';
