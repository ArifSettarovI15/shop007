...
class MainClass
{
    ...
    function __construct()
    {
        ...
        $transport2 = Swift_SendmailTransport::newInstance();

        if ($this->config['email']['smtp']['server']!='') {
            $transport = Swift_SmtpTransport::newInstance($this->config['email']['smtp']['server'],
        ...
        $this->system_mailer = Swift_Mailer::newInstance($transport2);
...
//	    $this->speed=new Speed($this);
        ...
        $this->route->ParseRoute($this->GPC["route"]);
