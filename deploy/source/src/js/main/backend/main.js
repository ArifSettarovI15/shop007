...
$(function() {
  ...
  $( document ).on( "change", ".vendor-collection", function(e) {
    ...
    $( document ).on( "keyup change", ".table_sale_input", function(e) {
        var price=$(this).closest('td').find('[name="price"]').val();
        if (price>0) {
          $(this).closest('td').find('[name="price_old"]').val(price/((100-$(this).val()*1)/100));
        }
  });

  $( document ).on( "keyup change", ".table_price_input", function(e) {
    var price_old=$(this).closest('td').find('[name="price_old"]').val()*1;
    if (price_old>0) {
      $(this).closest('td').find('.table_sale_input').val($(this).val()/price_old*100-100);
    }
  });
  $( document ).on( "keyup change", ".table_price2_input", function(e) {
    var price=$(this).closest('td').find('[name="price"]').val()*1;
    if (price>0) {
      $(this).closest('td').find('.table_sale_input').val(price/$(this).val()*100-100);
    }
  });

  $( document ).on( "blur", ".table_price_input, .table_price2_input, .table_amount_input, .table_sale_input, .table_title_input, .table_market_input", function(e) {
    var data={};
    ...
    data['title']=$('[data-id="'+$(this).attr('data-id')+'"].table_title_input').val();
    data['market']=$('[data-id="'+$(this).attr('data-id')+'"].table_market_input').val();
  ...
  $( document ).on( "click", ".update-all-price", function(e) {
    ...
    data['change_skidka_b']=$('.change_skidka_b').prop('checked');
    data['skidka_b']=$('.mass-skidka-b-update').val();
    data['price_change']=$('.mass-price-update').val();
    data['badge_change']=$('.mass-badge-update').val();
    data['price_type']=$('.mass-price-type').val();
    data['price_sprav']=$('.mass-sprav').val();
    data['price_sprav2']=$('.mass-sprav2').val();
    data['price_sprav_way']=$('.mass-sprav-way').val();
    data['ids']=[];
    $('.mass-check-one:checked').each(function(index,value) {
    ...
    data['item_status']=$('[data-name="item_status"]').val();
    data['badge']=$('[data-name="badge"]').val();
    data['item_icon_isset']=$('[data-name="item_icon_isset"]').val();
    data['item_vendor_id']=$('[data-name="item_vendor_id"]').val();
    data['q']=$('[data-name="q"]').val();
    data['cat_parent_id']=$('[data-name="cat_parent_id"]').val();

    data['item_price_min']=$('[data-name="item_price_min"]').val();
    data['item_price_max']=$('[data-name="item_price_max"]').val();
    data['item_amount_min']=$('[data-name="item_amount_min"]').val();
    data['item_amount_max']=$('[data-name="item_amount_max"]').val();
    ...
    options['show_and_hide']=3;
    options['AfterDone']=MassPriceDone;
