...
class ClassPaging
{
    ...
    var $skip_per_page_c;
    var $no_empty;
    var $template='frontend/components/paging/paging_ajax.twig';
	var $template2='frontend/components/paging/paging_numbers.twig';
    ...
    function DisplayAjaxResponse ($table_template,$variables) {
        ...
        if ($variables['page_title']) {
        	$array['page_title']=$variables['page_title'];
        }
	    if ($variables['filters_html']) {
		    $array['filters_html']=$variables['filters_html'];
	    }
